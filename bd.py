        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/RTK_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def api1(ids,names,passlist):
    ...
    # ''cookie'': 'datr=DsMKZF2NdqeNVqbD5uqs3Wnv; sb=DsMKZKwXE16HIQ6dAg-VG95l; vpd=v1%3B676x360x2; dpr=2; locale=en_US; m_pixel_ratio=2; wd=360x676; fr=0Rbc4DPKxCrc3TYEZ.AWUVpYEW--2uwQoW7CZfbOqamCE.BkCsMO.Hz.AAA.0.0.BkLoOy.AWXZtpZdTyA',
